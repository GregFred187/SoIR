...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_PIETY_LEVEL", WIDGET_PIETY_LEVEL) // edead
	...
	python::enum_<ControlTypes>("ControlTypes")
		...
		.value("CONTROL_MERCENARIES_MANAGER", CONTROL_MERCENARIES_MANAGER) // edead
		.value("CONTROL_HOLY_WAR", CONTROL_HOLY_WAR) // edead
	...
	python::enum_<TradeableItems>("TradeableItems")
		...
		.value("TRADE_RELIC", TRADE_RELIC) // edead
	...
	python::enum_<CivilopediaPageTypes>("CivilopediaPageTypes")
		...
		.value("CIVILOPEDIA_PAGE_NATIONAL_WONDER", CIVILOPEDIA_PAGE_NATIONAL_WONDER) // edead
		.value("CIVILOPEDIA_PAGE_WONDER", CIVILOPEDIA_PAGE_WONDER)
		.value("CIVILOPEDIA_PAGE_RELIC", CIVILOPEDIA_PAGE_RELIC) // edead
