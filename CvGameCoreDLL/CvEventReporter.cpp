...
void CvEventReporter::cityAcquiredAndKept(PlayerTypes iPlayer, CvCity* pCity, bool bMassacre) // edead: Massacre the Disbelievers
{
//	m_kPythonEventMgr.reportCityAcquiredAndKept(iPlayer, pCity);
	m_kPythonEventMgr.reportCityAcquiredAndKept(iPlayer, pCity, bMassacre); // edead: Massacre the Disbelievers
}
