...
void CvDllTranslator::initializeTags(CvWString& szTagStartIcon, CvWString& szTagStartOur, CvWString& szTagStartCT, CvWString& szTagStartColor, CvWString& szTagStartLink, CvWString& szTagEndLink, CvWString& szEndLinkReplacement, std::map<std::wstring, CvWString>& aIconMap, std::map<std::wstring, CvWString>& aColorMap)
{
	...
	// edead: start
	aIconMap[L"[ICON_JUDAISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_JUDAISM).getChar());
	aIconMap[L"[ICON_CATHOLICISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_CATHOLICISM).getChar());
	aIconMap[L"[ICON_ORTHODOXY]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_ORTHODOXY).getChar());
	aIconMap[L"[ICON_HINDUISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_HINDUISM).getChar());
	aIconMap[L"[ICON_SUNNI]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_SUNNI).getChar());
	aIconMap[L"[ICON_SHIA]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_SHIA).getChar());
	aIconMap[L"[ICON_BUDDHISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_BUDDHISM).getChar());
	aIconMap[L"[ICON_ZOROASTRIANISM]"] = std::wstring(1, (wchar)GC.getReligionInfo(RELIGION_ZOROASTRIANISM).getChar());
	aIconMap[L"[ICON_SUFISM]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_SUFISM).getChar());
	aIconMap[L"[ICON_ASSASSINS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_ASSASSINS).getChar());
	aIconMap[L"[ICON_HOSPITALLERS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_HOSPITALLERS).getChar());
	aIconMap[L"[ICON_TEMPLARS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_TEMPLARS).getChar());
	aIconMap[L"[ICON_VENETIANS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_VENETIANS).getChar());
	aIconMap[L"[ICON_GENOANS]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_GENOANS).getChar());
	aIconMap[L"[ICON_ESTADO]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_ESTADO).getChar());
	aIconMap[L"[ICON_KARIMI]"] = std::wstring(1, (wchar)GC.getCorporationInfo(CORPORATION_KARIMI).getChar());
	// edead: end
