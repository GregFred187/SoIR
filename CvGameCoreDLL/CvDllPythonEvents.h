...
public:
	...
	//void reportCityAcquiredAndKept(PlayerTypes ePlayer, CvCity* pCity); // edead
	void reportCityAcquiredAndKept(PlayerTypes ePlayer, CvCity* pCity, bool bMassacre = false); // edead: Massacre the Disbelievers
