...
//void CvDllPythonEvents::reportCityAcquiredAndKept(PlayerTypes ePlayer, CvCity* pOldCity) // edead
void CvDllPythonEvents::reportCityAcquiredAndKept(PlayerTypes ePlayer, CvCity* pOldCity, bool bMassacre) // edead: Massacre the Disbelievers
{
	if (preEvent())
	{
		CyArgsList eventData;
		...
		eventData.add(bMassacre); // edead: Massacre the Disbelievers
