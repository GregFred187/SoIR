...
class CvEventManager:
	def __init__(self):
		...
		self.EventHandlerMap = {
			...
			'revolution'			: self.onRevolution, # edead
		}
...
#################### ON EVENTS ######################
	...
	def onGameStart(self, argsList):
		...
		if not gc.getGame().isOption(GameOptionTypes.GAMEOPTION_ADVANCED_START): # edead
	...
	def onCityAcquiredAndKept(self, argsList):
		...
		iOwner,pCity,bMassacre = argsList # edead
